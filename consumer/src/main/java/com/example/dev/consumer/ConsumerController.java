...
public class ConsumerController {
  ...
  public String consumer1() {
    ...
    return getRestTemplate()
        .getForObject("http://gateway/" + getApiserver().get() + "/response1", String.class);
  }
  ...
  public String consumer2() {
    return getRestTemplate()
        .getForObject("http://gateway/" + getApiserver().get() + "/response2", String.class);
  }
  ...
  public String error() {
    return getRestTemplate()
        .getForObject("http://gateway/" + getApiserver().get() + "/error", String.class);
  }

  private Optional<String> getApiserver() {
    List<String> strings =
        Arrays.asList("api-a", "api-b", "api-a", "api-b", "api-a", "api-b", "api");
    Optional<String> apiServer =
        strings.stream().skip((int) (strings.size() * Math.random())).findAny();
